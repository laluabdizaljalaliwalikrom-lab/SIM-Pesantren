        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1 sm:w-64">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 text-sm bg-slate-50 dark:bg-zinc-800 rounded-xl border border-slate-200 dark:border-zinc-700 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
          </div>
        </div>
      </div>
