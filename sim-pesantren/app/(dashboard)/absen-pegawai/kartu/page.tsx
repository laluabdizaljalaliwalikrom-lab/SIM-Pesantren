    ...
    if (side === 'front') {
      ...
      <div style="width:220px;height:340px;border-radius:16px;overflow:hidden;position:relative;display:flex;flex-direction:column;border:1px solid rgba(4,47,38,0.4);box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#ffffff;background:#022c22;">
        ...
        <div style="margin:8px;padding:10px;border-radius:12px;background:rgba(255,255,255,0.08);border:1px solid rgba(251,191,36,0.25);flex:1;display:flex;flex-direction:column;align-items:center;justify-content:space-between;z-index:10;box-sizing:border-box;">
          ...
          <!-- Profile Photo -->
          <div style="position:relative;padding:2px;border-radius:50%;border:2px solid #d97706;background:rgba(255,255,255,0.1);">
            ${pegawai.foto_url ? `<img src="${pegawai.foto_url}" style="width:56px;height:56px;border-radius:50%;object-fit:cover;display:block;"/>` : `<div style="width:56px;height:56px;border-radius:50%;background:linear-gradient(135deg, #065f46, #022c22);display:flex;align-items:center;justify-content:center;color:#ffffff;font-size:18px;font-weight:bold;">${getInitials(pegawai.nama_lengkap)}</div>`}
            <div style="position:absolute;bottom:0;right:0;width:14px;height:14px;background:#d97706;border-radius:50%;display:flex;align-items:center;justify-content:center;color:#ffffff;font-size:8px;font-weight:bold;border:1px solid #ffffff;">✓</div>
          </div>
